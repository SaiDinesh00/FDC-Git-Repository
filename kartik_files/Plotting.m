...
hold on
plot(t, vecnorm(X(8:10,:)),'--', 'LineWidth', 3, 'Color','m', 'DisplayName', 'Desired')
hold off
xlabel("Time (seconds)")
ylabel("V (m/s)")
ax3.LineWidth = 1.2;
...
subplot(2, 2, 1);
ax1 = gca;
plot(t, X(14,:), 'LineWidth', 3, 'Color','g', 'DisplayName', 'Actual')
xlabel("Time (seconds)")
ylabel("C_{T_1}")
ax1.LineWidth = 1.2;
ax1.FontSize = 12;
...
subplot(2, 2, 2); 
ax2 = gca;
plot(t, X(15,:), 'LineWidth', 3, 'Color','g', 'DisplayName', 'Actual')
xlabel("Time (seconds)")
ylabel("C_{T_2}")
ax2.LineWidth = 1.2;
ax2.FontSize = 12;
...
subplot(2, 2, 3); 
ax3 = gca;
plot(t, X(16,:), 'LineWidth', 3, 'Color','g', 'DisplayName', 'Actual')
xlabel("Time (seconds)")
ylabel("C_{T_3}")
ax3.LineWidth = 1.2;
ax3.FontSize = 12;
...
subplot(2, 2, 4); 
ax3 = gca;
plot(t, X(17,:), 'LineWidth', 3, 'Color','g', 'DisplayName', 'Actual')
xlabel("Time (seconds)")
ylabel("C_{T_4}")
ax3.LineWidth = 1.2;
ax3.FontSize = 12;
